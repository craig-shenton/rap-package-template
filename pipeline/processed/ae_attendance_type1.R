...
# DESCRIPTION:    Overall, this code filters and manipulates the dataframe
#                 to calculate performance metrics, add a month column,
#                 calculates mean, min, and max values, join ODS codes, and
